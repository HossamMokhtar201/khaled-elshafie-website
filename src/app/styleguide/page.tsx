  ...
  return (
    <Container className="py-16">
      <h1 className="mb-2 font-heading text-4xl font-extrabold">
        دليل التصميم (Styleguide)
      </h1>
      <p className="mb-8 text-text-secondary">
        صفحة داخلية للمراجعة فقط — تعرض كل مكونات نظام التصميم بحالاتها
        المختلفة.
      </p>
      ...
      <Section title="التايبوجرافي">
        <p className="font-heading text-3xl font-bold">
          عنوان بخط Noto Kufi Arabic
        </p>
        <p className="mt-2 text-base">
          نص أساسي بخط IBM Plex Sans Arabic — قراءة مريحة رسمية.
        </p>
        <p className="mt-2 font-quote text-2xl text-primary-800">
          جملة مقتبسة بخط Aref Ruqaa
        </p>
      </Section>
