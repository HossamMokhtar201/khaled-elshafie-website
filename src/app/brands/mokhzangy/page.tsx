...
export default function MokhzangyPage() {
  return (
    <>
      ...
      >
        <Container>
          <h1 id="mokhzangy-heading" className="font-heading text-4xl font-extrabold">
            {mokhzangy.name}
          </h1>
      ...
      <section aria-labelledby="mokhzangy-story-heading" className="py-16">
        <Container>
          <h2 id="mokhzangy-story-heading" className="mb-4 font-heading text-2xl font-bold">
            قصة البراند
          </h2>
      ...
      <section aria-labelledby="mokhzangy-categories-heading" className="border-t border-border bg-bg-alt py-16">
        <Container>
          <h2 id="mokhzangy-categories-heading" className="mb-4 font-heading text-2xl font-bold">
            الفئات
          </h2>
      ...
      <section aria-labelledby="mokhzangy-gallery-heading" className="border-t border-border py-16">
        <Container>
          <h2 id="mokhzangy-gallery-heading" className="mb-4 font-heading text-2xl font-bold">
            معرض الصور
          </h2>
      ...
      <section aria-labelledby="mokhzangy-pricing-heading" className="border-t border-border bg-bg-alt py-16">
        <Container>
          <h2 id="mokhzangy-pricing-heading" className="mb-4 font-heading text-2xl font-bold">
            فلسفة التسعير
          </h2>
          <p className="max-w-2xl text-text-secondary">{mokhzangy.pricingPhilosophy}</p>
        </Container>
      </section>

      <section aria-labelledby="mokhzangy-branches-heading" className="border-t border-border py-16">
        <Container>
          <h2 id="mokhzangy-branches-heading" className="mb-4 font-heading text-2xl font-bold">
            الفروع
          </h2>
