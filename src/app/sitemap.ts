...
const staticRoutes = [
  ...
  { path: "/brands/mokhzangy", priority: 0.8, changeFrequency: "monthly" as const },
  { path: "/brands/alibaba", priority: 0.8, changeFrequency: "monthly" as const },
  {
    path: "/brands/alibaba/branch-opportunities",
    priority: 0.6,
    changeFrequency: "monthly" as const,
  },
  { path: "/consultations", priority: 0.9, changeFrequency: "monthly" as const },
  { path: "/consultations/book", priority: 0.7, changeFrequency: "monthly" as const },
  ...
  { path: "/investments/real-estate", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/investments/opportunities", priority: 0.6, changeFrequency: "monthly" as const },
