...
export default function ProjectGrid({ projects }: { projects: typeof ProjectsType }) {
  ...
  return (
    <div>
      <div className="mb-6 flex flex-wrap gap-2" role="group" aria-label="فلترة حسب الحالة">
        {statuses.map((s) => (
          <button
            key={s}
            type="button"
