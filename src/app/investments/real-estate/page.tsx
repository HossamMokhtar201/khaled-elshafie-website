  ...
  return (
    <>
      ...
      <section aria-labelledby="steps-heading" className="py-16">
        <Container>
          <h2 id="steps-heading" className="mb-8 font-heading text-3xl font-bold">
            خطوات الآلية
          </h2>
          <ol className="space-y-4 border-e-2 border-accent-500 pe-6">
            {unionSystem.steps.map((step, i) => (
              <li key={step}>
                <span className="font-heading font-bold text-accent-600">{i + 1}. </span>
      ...
      <section aria-labelledby="projects-heading" className="border-t border-border bg-bg-alt py-16">
        <Container>
          <h2 id="projects-heading" className="mb-8 font-heading text-3xl font-bold">
            المشاريع
          </h2>
      ...
      <section aria-labelledby="faq-heading" className="border-t border-border py-16">
        <Container>
          <h2 id="faq-heading" className="mb-8 font-heading text-3xl font-bold">
            الأسئلة الشائعة
          </h2>
