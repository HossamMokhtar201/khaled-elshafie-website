...
export default function AlibabaPage() {
  return (
    <>
      ...
      <section
        aria-labelledby="alibaba-categories-heading"
        className="border-t border-border bg-bg-alt py-16"
      >
        <Container>
          <Reveal>
            <h2
              id="alibaba-categories-heading"
              className="mb-4 font-heading text-2xl font-bold"
            >
              الفئات
            </h2>
      ...
      <section
        aria-labelledby="alibaba-gallery-heading"
        className="border-t border-border py-16"
      >
        <Container>
          <Reveal>
            <h2
              id="alibaba-gallery-heading"
              className="mb-4 font-heading text-2xl font-bold"
            >
              معرض الصور
            </h2>
      ...
      <section
        aria-labelledby="alibaba-branches-heading"
        className="border-t border-border bg-bg-alt py-16"
      >
        <Container>
          <Reveal>
            <h2
              id="alibaba-branches-heading"
              className="mb-4 font-heading text-2xl font-bold"
            >
              الفروع
            </h2>
        ...
        <Container>
          <Reveal>
            ...
            <p className="max-w-2xl text-text-secondary">
              {alibaba.branchOpportunities.intro}
            </p>
            <Link
